...
class Album1 {
  ...
  Album1({this.latitude, this.longitude, this.velocity, this.visibility});
...
class Response{
  ...
  Response.fromJson(Map<String, dynamic> json) {
    ...
    risetime = "Day: "+ dt.day.toString()+"/"+dt.month.toString()+"/"+dt.year.toString()+ " Time: "+dt.hour.toString()+":"+dt.minute.toString()+":"+dt.second.toString();
...
class Album3{
  ...
  Album(this.latitude, this.longitude, this.velocity, this.visibility, this.number, this.people, this.response );
...
Future<Album> fetchAlbum() async {
  ...
  if (response1.statusCode == 200 ) {
    ...
    a1=Album1.fromJson(jsonresponse1);
  } else {
  ...
  a=Album(a1.latitude, a1.longitude, a1.velocity, a1.visibility,a2.number, a2.people, a3.response);
  return a;
